    ...
    <div class="box1">
      ...
      <div class="dropdown-box">
        <el-collapse v-model="activeName" accordion>
          <el-collapse-item
            v-for="(value, i) in dataTable"
            :title="value.tokenAllocation"
            :key="i"
            :name="i"
      ...
      <div class="chart-container">
        <div class="chart"><img v-lazy="image1" style="" alt="" /></div>
      </div>
    </div>
    <LynkeyNft /> <product-roadmap /> <lynkey-vision /> <board-member />
    <div class="box-6">
      <div class="box-6-content">
        ...
        <div class="isComputer">
          <div class="grid wide"><img v-lazy="image2" style="" alt="" /></div>
          <div class="title-1">
            <div class="title-folder">
          ...
          <div class="grid wide" style="margin-bottom: 24px">
            <img v-lazy="image3" style="" alt="" />
          </div>
          <div class="grid wide" style="margin-bottom: 24px">
            <img v-lazy="image4" style="" alt="" />
          </div>
          <div class="grid wide"><img v-lazy="image5" style="" alt="" /></div>
        </div>
        <div class="isMobile maplogo"><img v-lazy="image6" alt="" /></div>
      </div>
    </div>
    <new-and-video />
    <AskUsAnything />
